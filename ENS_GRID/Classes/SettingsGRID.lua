...
function Settings:Init()
  ...
  self.main_position = {x=0,y=0,dx=1500,dy=150} --позиция главного окна
  self.log_position = {x=0,y=150,dx=1200,dy=300} --позиция окна логов
  
  self.signals_position = {x=0,y=450,dx=1200,dy=150} --позиция окна сигналов
  self.orders_position = {x=0,y=600,dx=1200,dy=150} --позиция окна заявок
...
function Settings:instruments_list()
	...
	row, secList = addOneInstrumentToTable(row, {'BRENT','BR', 'BRQ7',2, 'revers', 'SPBFUT', 'SPBFUT00922', 'SPBFUT00922', 'start'}, secList) --brent BR-4.17
    ...
    --акции на споте
	---[[
	row, secList = addOneInstrumentToTable(row, {'AFK',	'', 'AFKS', 10, 'revers', 'QJSIM', '10646', 'NL0011100043', 'start'}, secList)
	...
	row, secList = addOneInstrumentToTable(row, {'AGRO',	'', 'AGRO', 10, 'long', 'QJSIM', '10646', 'NL0011100043', 'start'}, secList)
	...
	row, secList = addOneInstrumentToTable(row, {'MAGNIT',		'', 'MGNT', 10, 'revers', 'QJSIM', '10646', 'NL0011100043', 'start'}, secList)
	...
	row, secList = addOneInstrumentToTable(row, {'MEGAFON',		'', 'MFON', 10, 'long', 'QJSIM', '10646', 'NL0011100043', 'start'}, secList)
	row, secList = addOneInstrumentToTable(row, {'MTS',		'', 'MTSS', 10, 'long', 'QJSIM', '10646', 'NL0011100043', 'start'}, secList)
	row, secList = addOneInstrumentToTable(row, {'NLMK',		'', 'NLMK', 10, 'revers', 'QJSIM', '10646', 'NL0011100043', 'start'}, secList)
	row, secList = addOneInstrumentToTable(row, {'POLYMETAL',		'', 'POLY', 10, 'revers', 'QJSIM', '10646', 'NL0011100043', 'start'}, secList)
	...
	row, secList = addOneInstrumentToTable(row, {'URKA',		'', 'URKA', 10, 'long', 'QJSIM', '10646', 'NL0011100043', 'start'}, secList)
